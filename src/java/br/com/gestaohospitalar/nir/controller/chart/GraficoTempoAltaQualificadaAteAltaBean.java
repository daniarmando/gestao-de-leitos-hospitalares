...
@ManagedBean
@ViewScoped
public class GraficoTempoAltaQualificadaAteAltaBean implements Serializable {
    ...
    /**
     * Creates a new instance of GraficoTempoAltaQualificadaAteAltaBean
     */
    public GraficoTempoAltaQualificadaAteAltaBean() {
    ...
    public void prepararGrafico() {
        ...
        if (PeriodoValidator.comparaDatas(this.dataInicial, this.dataFinal) == false) {
            ...
            if (this.leitos.isEmpty()) {
                ...
                graficoTempoAltaQualificadaAteAlta();
            }
        }
    }

    /**
     * método que chama as rotinas para montar o gráfico de tempo de tempo alta
     * qualificada até alta
     *
     */
    public void graficoTempoAltaQualificadaAteAlta() {
        ...
        switch (this.modeloGrafico) {
            ...
            case 2: //gráfico de área
                ...
                layoutGraficoLinha("Diferença Tempo de Previsão de Alta até Efetivação da Alta", "Data previsão de alta", "Diferença em horas");
                break;

            case 3: //gráfico de barra
                //montando o layout do gráfico de barra
                layoutGraficoBarra("Diferença Tempo de Previsão de Alta até Efetivação da Alta", "Data previsão de alta", "Diferença em horas");
                break;
        }
    ...
    public void adicionarSerie(Integer idLeito, String rotulo) {
        ...
        //recebendo os valores do tempo de alta x altaqualificada por leitos do período informado
        Map<Date, Double> valoresPorData = tempoAltaQualificadaAteAlta(idLeito, this.dataInicial, this.dataFinal);
    ...
    /**
     * método que retorna os valores do tempo de alta qualificada x alta por
     * leitos do período informado
     *
     * @param idLeito
     * @param dataInicial
     * @param dataFinal
     * @return resultado
     */
    public Map<Date, Double> tempoAltaQualificadaAteAlta(Integer idLeito, Date dataInicial, Date dataFinal) {
        ...
        //de dataHoraPrevisaoAlta da alta qualificada (eixo x)
        //e tempo em minutos da diferença alta qualificada x alta (eixo y)
        for (Estatisticas estatistica : this.listaEstatisticas) {

            if (estatistica.getAltaQualificada() != null) {
                //calculando diferença alta qualificada x alta em horas
                qtdDifTempoHoras = estatistica.getTempoAltaQualificadaAteAlta() / 3600.0;

                //adicionando as informações ao map
                resultado.put(estatistica.getInternacao().getDataSaidaLeito(), qtdDifTempoHoras);
            }
