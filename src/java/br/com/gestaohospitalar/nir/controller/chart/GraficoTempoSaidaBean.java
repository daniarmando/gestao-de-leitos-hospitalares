...
@ManagedBean
@ViewScoped
public class GraficoTempoSaidaBean implements Serializable {
    ...
    /**
     * Creates a new instance of GraficoTempoSaidaBean
     */
    public GraficoTempoSaidaBean() {
    ...
    /**
     * método que chama as rotinas para montar o gráfico de tempo de saída do
     * paciente
     *
     */
    public void graficoTempoSaida() {
        ...
        switch (this.modeloGrafico) {
            ...
            case 2: //gráfico de área
                ...
                layoutGraficoLinha("Tempo de Saída do Paciente", "Data saída", "Duração em minutos");
                break;

            case 3: //gráfico de barra
                //montando o layout do gráfico de barra
                layoutGraficoBarra("Tempo de Saída do Paciente", "Data saída", "Duração em minutos");
                break;
        }
    ...
    public void adicionarSerie(Integer idLeito, String rotulo) {
        ...
        //recebendo os valores do tempo de saída por leitos do período informado
        Map<Date, Double> valoresPorData = tempoSaida(idLeito, this.dataInicial, this.dataFinal);
    ...
    /**
     * método que retorna os valores do tempo de saída por leitos do período
     * informado
     *
     * @param idLeito
     * @param dataInicial
     ...
     * @return resultado
     */
    public Map<Date, Double> tempoSaida(Integer idLeito, Date dataInicial, Date dataFinal) {
        ...
        //e tempo em minutos da saída (eixo y)
        for (Estatisticas estatistica : this.listaEstatisticas) {

            //calculando o tempo da saída em minutos
            qtdMinutosSaida = estatistica.getTempoSaidaPaciente() / 60.0;

            //adicionando as informações ao map
            resultado.put(estatistica.getInternacao().getDataSaidaLeito(), qtdMinutosSaida);
